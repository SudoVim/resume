...
Memory Systems. The testing platform was written in Python using nose to run
tests against a simulated version of our embedded software stack.
...
systems running different iterations of hardware and software.
